...
export const ThemeToggle = ({ className }: ThemeToggleProps) => {
  ...
  return (
    <button onClick={toggleTheme}
            className={cn("p-2 rounded-md inline-block hover:bg-base-primary/10 transition-colors duration-200 hover:cursor-pointer", className)}>
      {isDark ? (
        ...
        (
          <svg xmlns="http://www.w3.org/2000/svg" className={" h-[24px] w-[24px] fill-base-primary"}
               viewBox="0 0 256 256">
            <path
